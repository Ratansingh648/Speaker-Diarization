...
class VAD(object):
    ...
    def __init__(self, window_length=30, moving_average_width=8, max_silence_length=6):
    ...
    def detect_voice(self, wav, sampling_frequency, aggression_mode=3, trim = False):
        ...
        for window_start in range(0, len(wav), samples_per_window):
            ...
            voice_flags.append(vad.is_speech(pcm_wav[window_start*2 : window_end*2], sampling_frequency))
